...
repeat
 ...
 for _, obj in pairs(menu:GetDescendants()) do
    if obj.Name:lower():find('userlabel') then
        obj.Text = 'active user: <font color="rgb(0, 126, 255)">' .. do game:GetService("Players").LocalPlayer.Name .. '</font>'
    end
    if obj.Name:lower():find('buildlabel') then
        obj.Text = 'build: <font color="rgb(0, 126, 255)">Public</font>'
    end
 end
 ...
 KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 126, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
 ...
 Name.Text = "[<font color=\"rgb(0, 126, 255)\">Keybinds</font>]"
 ...
 Name_2.Text = "Silent Aim: <font color=\"rgb(0, 126, 255)\">[MB1]</font>"
 ...
 local function createWatermark()
    ...
    WatermarkFrame.BorderColor3 = Color3.fromRGB(0, 126, 255)
    ...
    task.spawn(function()
       while task.wait() do
         ...
         local ping = string.format('%.0f', do game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValue())
         local uid = "1"
         local fpsValue = string.split(do game:GetService("Stats").Workspace.Heartbeat:GetValueString(), ".")[1]
 ...
 local library = {
    ...
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(0, 126, 255),
          riskyColor = Color3.fromRGB(255, 0, 0),
          FontColor = Color3.fromRGB(255, 255, 255),
          MainColor = Color3.fromRGB(14, 14, 14),
          AccentColor = Color3.fromRGB(0, 126, 255),
    ...
    BuildLabel.Text = "build: <font color=\"rgb(0, 126, 255)\">public</font>"
    ...
    ActiveUserLabel.Text = "active user: <font color=\"rgb(0, 126, 255)\">7d</font>"
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(0, 126, 255)">' .. do game:GetService("Players").LocalPlayer.Name .. '</font>'
        end
    end
    ...
    library:Create('UIListLayout', {Padding = UDim.new(0, 4); FillDirection = Enum.FillDirection.Vertical; SortOrder = Enum.SortOrder.LayoutOrder; Parent = library.NotificationArea})
        ...
        function library:Notify(Text, Time)
            ...
            local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(0, 126, 255); Position = UDim2.new(0, 100, 0, 10); Size = UDim2.new(0, 0, 0, YSize); ClipsDescendants = true; Transparency = 0; ZIndex = 100; Parent = library.NotificationArea})
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(0, 126, 255)})
                        local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(0, 126, 255)})
                        ...
                        function group:addToggle(args)
                            ...
                            function toggle:addKeybind(args)
                                    ...
                                    if key.Name == "Unknown" or key.Name == "Unknown" then
                                        ...
                                        if args.gui then
                                            ...
                                            if args.type == "hold" then
                                                Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(0, 126, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                            else
                                                if not Toggle then
                                                    Toggle = true
                                                    Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(0, 126, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                    ...
                                                    Toggle = false
                                                    Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(0, 126, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                end
                                            end
                                        end
                                    end
                                ...
                                if args.gui then
                                    Name.Visible = true
                                    Name.Text = args.text..": <font color=\"rgb(0, 126, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                end
