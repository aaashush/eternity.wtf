...
repeat
 ...
 for _, obj in pairs(menu:GetDescendants()) do
    if obj.Name:lower():find('userlabel') then
        obj.Text = 'active user: <font color="rgb(0, 126, 255)">' .. game:GetService("Players").LocalPlayer.Name .. '</font>'
    end
 ...
 local library = {
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(0, 126, 255)">' .. game:GetService("Players").LocalPlayer.Name .. '</font>'
        end
    end
